...
namespace BLL.Interfaces.Services
{
    public interface IProductServices
    {
        ...
        public Task<IEnumerable<Product>> GetProductsByCategoryAndPrice(string category, double max, double min);
        public Task<IEnumerable<Product>> GetProductsByCategoryAndKeyWordsWithPrice(string category, string[] keywords, double max, double min);
    }
}
